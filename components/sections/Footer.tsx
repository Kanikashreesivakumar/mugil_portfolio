  ...
  return (
    <footer className="bg-neutral-900 text-white">
      ...
      <div className="container mx-auto px-6 py-16">
          ...
          >
            ...
            <div className="space-y-2">
              <div className="flex items-center text-neutral-400">
                ...
                <span className="text-sm">+91 6383792589</span>
              </div>
              <div className="flex items-center text-neutral-400">
                <HiMail className="w-4 h-4 mr-2" />
                <span className="text-sm">mukil0199@gmail.com</span>
              </div>
              <div className="flex items-center text-neutral-400">
                <HiLocationMarker className="w-4 h-4 mr-2" />
                <span className="text-sm">203c , Gounder nagar, Bhavani,Erode ,Tamilnad</span>
              </div>
            </div>
          </motion.div>
        ...
        {/* Social Media Links */}
        <motion.div
          className="flex justify-center space-x-6 mt-12 pt-8 border-t border-neutral-800"
        ...
        >
          {socialLinks.map((social, index) => (
            <motion.a
              ...
              className="w-10 h-10 bg-neutral-800 rounded-lg flex items-center justify-center text-neutral-400 hover:text-white hover:bg-primary-600 transition-all duration-300"
              data-cursor-hover
