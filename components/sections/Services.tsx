...
export const Services = () => {
  return (
    <>
      <section id="services" className="py-24 lg:py-32 gradient-bg">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl lg:text-4xl font-black text-[#739EC9] mb-8 text-center">Professional Experience</h2>
            <div className="max-w-3xl mx-auto space-y-8">
              <div className="bg-[#F7FAFC] rounded-2xl p-6 shadow-md border border-[#739EC9]/20">
                <h3 className="text-2xl font-bold text-[#739EC9] mb-2">Physiotherapist – Jogo Healthcare, Bangalore</h3>
              ...
              <div className="bg-[#F7FAFC] rounded-2xl p-6 shadow-md border border-[#739EC9]/20">
                <h3 className="text-2xl font-bold text-[#739EC9] mb-2">Physiotherapist – Mom’s Belief Therakeyz, Bangalore</h3>
                <ul className="list-disc ml-6 text-neutral-700 space-y-1">
              ...
              <div className="bg-[#F7FAFC] rounded-2xl p-6 shadow-md border border-[#739EC9]/20">
                <h3 className="text-2xl font-bold text-[#739EC9] mb-2">Physiotherapist – Sukino Healthcare, Bangalore</h3>
                <ul className="list-disc ml-6 text-neutral-700 space-y-1">
            ...
            <h2 className="text-3xl lg:text-4xl font-black text-[#739EC9] mt-16 mb-8 text-center">Internships & Rotations</h2>
